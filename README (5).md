...
1. **Pressure Analysis**: Detects abnormal pressure drops (>8 PSI deviation)
2. **Flow Analysis**: Identifies unusual flow patterns (>30 GPM deviation)  
3. **Multi-Signal Correlation**: Requires agreement across both signals for high-confidence detections
4. **Zone-Based Risk Scoring**: Prioritizes critical infrastructure and population-dense areas
